...
html[data-skin="apple"]{
  --bg:#0c0c0f;--bg2:#17181c;--bg3:#202228;--bg4:#2a2d34;--line:#2f333b;--line2:#434954;
  --muted:#9ca3b0;--sub:#c4cad5;--sub2:#f7f8fb;--text:#f7f8fb;--text2:#e9edf3;
  --accent:#4da3ff;--accent2:#8dc5ff;--accent-d:rgba(77,163,255,.16);--accent-b:rgba(77,163,255,.28);--accent-rgb:77 163 255;
  --red:#ff8a7a;--red-d:rgba(255,138,122,.14);--green:#59d487;--green-d:rgba(89,212,135,.14);
  --blue:#4da3ff;--blue-d:rgba(77,163,255,.18);--orange:#ffb357;--violet:#8f8fff;
  --r:28px;--r-sm:20px;--menu-font:-apple-system,BlinkMacSystemFont,'SF Pro Display','Segoe UI',sans-serif;
  --shell:rgba(28,29,33,.82);--shell-2:rgba(38,40,46,.9);--shell-border:rgba(255,255,255,.10);--shell-card:rgba(34,36,42,.9);--shell-input:rgba(44,47,54,.88);
  --shadow:0 32px 120px rgba(0,0,0,.34);
}
html[data-skin="apple"][data-t="light"]{
  --bg:#eceef3;--bg2:#ffffff;--bg3:#f5f6fa;--bg4:#eceef5;--line:#d7dbe4;--line2:#c2c8d4;
  --muted:#757f8f;--sub:#5d6777;--sub2:#13161d;--text:#11141a;--text2:#20242d;
...
color:var(--text)}
html[data-skin="apple"] body{background:
  radial-gradient(circle at 50% -10%,rgba(255 255 255 / .08) 0%,transparent 34%),
  radial-gradient(circle at 82% 12%,rgba(77 163 255 / .14) 0%,transparent 18%),
  linear-gradient(180deg,#101114 0%,#0d0e12 100%)}
html[data-skin="apple"][data-t="light"] body{background:
...
html[data-skin="apple"] body::before{opacity:.18;background:
...
html[data-skin="apple"] .ni{gap:12px;padding:12px 14px;border-radius:18px;min-height:48px;color:var(--text2)}
html[data-skin="apple"] .ni:hover{transform:none;background:rgba(255,255,255,.12);border-color:rgba(255,255,255,.10)}
html[data-skin="apple"] .ni.on{background:rgba(255,255,255,.20);border-color:rgba(255,255,255,.14);box-shadow:inset 0 1px 0 rgba(255,255,255,.14)}
html[data-skin="apple"] .ni.on::before{display:none}
...
html[data-skin="apple"] .btn{padding:11px 18px;border-radius:999px}
...
html[data-skin="apple"] .card{background:linear-gradient(180deg,rgba(255,255,255,.22),rgba(255,255,255,.10) 18%,transparent 50%),var(--shell-card);border-color:rgba(255,255,255,.10);border-radius:30px;padding:22px;backdrop-filter:blur(24px)}
...
html[data-skin="apple"] .note-pop,
html[data-skin="apple"] .note-context-menu,
html[data-skin="apple"] .account-link,
html[data-skin="apple"] .sb-account-pop{background:linear-gradient(180deg,rgba(255,255,255,.22),rgba(255,255,255,.10) 18%,transparent 48%),var(--shell-card);border-color:rgba(255,255,255,.10);backdrop-filter:blur(28px);border-radius:28px}
html[data-skin="apple"] .content{padding:20px 22px}
html[data-skin="apple"] .dashboard-hero-main,
html[data-skin="apple"] .dashboard-side-panel,
html[data-skin="apple"] .dashboard-widgets,
html[data-skin="apple"] .note-side-card,
html[data-skin="apple"] .note-editor-card,
