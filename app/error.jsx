...
export default function Error({ error, reset }) {
  useEffect(() => {
    console.error("[FlowSegmentError]", error);
  }, [error]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ fontSize: 26, margin: "0 0 8px" }}>Une erreur a ete interceptee.</h1>
        <p style={{ margin: "0 0 14px", color: "#a6a29a", lineHeight: 1.6 }}>
          Flow a capture le probleme et evite maintenant la page d'erreur brute du navigateur.
        </p>
        <div style={{
          borderRadius: 16,
        ...
        >
          {error?.message || "Erreur client capturee"}
        </div>
