export const RELEASE = {
  version: "1.25.5",
  deployedAt: "2026-05-02T03:00:00+02:00",
  summary: "Flow corrige le module Notes avec une vraie vue catégorie, un éditeur stable sans saisie inversée, un menu texte en popup et un mode fausses données Shopify réversible même avec une boutique connectée.",
  changes: [
    {
    ...
    {
      id: "notes-category-polish",
      status: "done",
      title: "Notes peaufiné",
      subtitle: "La création de catégorie passe par le bouton plus, la vue catégorie est simplifiée, le titre utilise un vrai placeholder et le menu texte T applique le style au texte sélectionné ou au prochain texte saisi.",
    },
    {
      id: "shopify-demo-override",
      status: "done",
      title: "Mode test Shopify réversible",
      subtitle: "Le bouton de données de travail remplace aussi Shopify par des données cohérentes pendant le test puis restaure les données réelles au second clic.",
    },
  ],
};
